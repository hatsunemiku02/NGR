...
public:
	...
	/// construct from rotation from lhs to rhs
	quaternion(const float3& lhs, const float3& rhs);
...
*/
__forceinline 
quaternion::quaternion(const Ogre::Quaternion& rhs) :
    vec(rhs)
{
    // empty
}
