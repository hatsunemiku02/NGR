...
public:
	...
	void MultiplyPoint3 (const float3& inV, float3& output) const;
...
{
    #if _DEBUG
	printf("w component not 0, use vector for translation not a point!");
    assert(t.w() == 0);
    #endif
...
#if RENDERDEVICE_OPENGL || RENDERDEVICE_OPENGLES20 || RENDERDEVICE_OPENGLES30
