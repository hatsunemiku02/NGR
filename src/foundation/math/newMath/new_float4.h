...
{
	float4 result;
	result.vec.x = (v0.vec.x > v1.vec.x ? v0.vec.x : v1.vec.x);
	result.vec.y = (v0.vec.y > v1.vec.y ? v0.vec.y : v1.vec.y);
	result.vec.z = (v0.vec.z > v1.vec.z ? v0.vec.z : v1.vec.z);
	result.vec.w = (v0.vec.w > v1.vec.w ? v0.vec.w : v1.vec.w);
	return result;
}
