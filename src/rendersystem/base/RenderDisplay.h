...
public:
    ...
    DisplayMode(uint x, uint y, uint w, uint h, uint rw, uint rh);
    /// fullscreen constructor
    DisplayMode(uint w, uint h, uint rw, uint rh, PixelFormat::Code p);
    /// generic constructor
    DisplayMode(uint x, uint y, uint w, uint h, uint rw, uint rh, PixelFormat::Code p);
    /// equality operator
	...
	void SetResolutionWidth(uint w);
	void SetResolutionHeight(uint h);

	uint GetResolutionWidth() const;
	uint GetResolutionHeight() const;
...
*/
inline
DisplayMode::DisplayMode(uint x, uint y, uint w, uint h, uint rw, uint rh) :
    xPos(x),
    yPos(y),
    width(w),
    height(h),
...
*/
inline
DisplayMode::DisplayMode(uint w, uint h, uint rw, uint rh, PixelFormat::Code p) :
    xPos(0),
    yPos(0),
    width(w),
    height(h),
...
*/
inline
DisplayMode::DisplayMode(uint x, uint y, uint w, uint h, uint rw, uint rh, PixelFormat::Code p) :
    xPos(x),
    yPos(y),
    width(w),
    height(h),
...
DisplayMode::operator==(const DisplayMode& rhs) const
{
    return ((this->xPos == rhs.xPos) &&
			...
			(this->resolutionWidth == rhs.resolutionWidth) &&
			(this->resolutionHeight == rhs.resolutionHeight) &&
...
*/
inline void
DisplayMode::SetResolutionWidth(uint w)
{
...
*/
inline void
DisplayMode::SetResolutionHeight(uint h)
{
...
*/
inline uint
DisplayMode::GetResolutionWidth() const
{
...
*/
inline uint
DisplayMode::GetResolutionHeight() const
{
...
public:
	...
	AdapterInfo();
	/// set driver name
	void SetDriverName(const std::string& s);
	...
	/// set device name
	void SetDeviceName(const std::string& s);
...
*/
inline void
AdapterInfo::SetDriverName(const std::string& s)
{
	this->driverName = s;
}
...
*/
inline void
AdapterInfo::SetDescription(const std::string& s)
{
	this->description = s;
}
...
*/
inline void
AdapterInfo::SetDeviceName(const std::string& s)
{
	this->deviceName = s;
}
...
public:
	...
	std::vector<DisplayMode> GetAvailableDisplayModes(Adapter::Code adapter, PixelFormat::Code pixelFormat);
...
*/
inline void
RenderDisplay::SetIconName(const std::string& s)
{
	this->iconName = s;
}
